function sendEmails() {
  ...
  var htmlOutput = HtmlService.createHtmlOutputFromFile('venue-email');
  ...
  for (var i = 0; i < data.length; ++i) {
    ...
    var emailAddress = row[6];  // Seventh column
    var message = "Hello, World \n. Timestamp: " + row[0];       // First Column
    var subject = "Thanks for registering as a venue with Code Club Aotearoa!";
